...
public class PaginaCuatroService {
	...
	public boolean addDepositsWithdrawalsPage(Document document, PdfWriter writer,
		...
		try {
			...
			addStyledCell(tablaDepositos, formatter.format(totalDepositos), colorFondoDepositos, colorTextoDepositos,
					true);
			...
			tablaRetiros.writeSelectedRows(0, -1, marginLeft + tableWidth + spaceBetweenTables, tableYPositionD,
					canvas);
	...
	private void addStyledCell(PdfPTable table, String text, BaseColor backgroundColor, BaseColor textColor,
		...
		Font font = FontFactory.getFont(FontFactory.HELVETICA_BOLD, isHeader ? 12 : 11, Font.NORMAL, textColor); // Fuente
																													// más
																													// pequeña
